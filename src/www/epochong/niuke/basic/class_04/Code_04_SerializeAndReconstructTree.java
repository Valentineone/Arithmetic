package www.epochong.niuke.basic.class_04;
//初级5_4
/*
...
public class Code_04_SerializeAndReconstructTree {
    ...
    /**
     * 按层序列化head为根结点的二叉树,通过while循环做的,不是递归
     * @param head 根结点
     * @return 一个按层序列化的字符串,包含分隔符
     */
