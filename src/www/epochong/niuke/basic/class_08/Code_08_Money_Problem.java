package www.epochong.niuke.class_08;
...
public class Code_08_Money_Problem {
    ...
    * 3  2  7  13      数9
    * 要3不要3两种
    *                             twoIntegerTo2Pow(0,0)
    *                   twoIntegerTo2Pow(1,3)                   twoIntegerTo2Pow(1,0)
    *       twoIntegerTo2Pow(2,5)               twoIntegerTo2Pow(2,3)          ...
    *  twoIntegerTo2Pow(3,12)  twoIntegerTo2Pow(3,5)     twoIntegerTo2Pow(3,10)   twoIntegerTo2Pow(3,3)
