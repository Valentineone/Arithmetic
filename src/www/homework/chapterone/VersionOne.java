...
/*        String str; //定义String变量用来保存每一次读到的每一行的数据
        ...
        File inDatFile = new File("F:\\Program\\java\\IDEA\\HomeWork\\in.dat");
        File inTxtFile = new File("F:\\Program\\java\\IDEA\\HomeWork\\in.txt");
        ...
        inTxt.close();
        inDat.close();
        BufferedReader in = new BufferedReader(new FileReader("F:\\Program\\java\\IDEA\\HomeWork\\in.dat"));//打开文件创建数据流
...
//            }
        ...
        File outFile = new File("F:\\Program\\java\\IDEA\\HomeWork\\out.txt");
