package www.homework.chapter_3;
...
public class FourRandomGameOf24 {
    ...
    private static HashMap<Integer,String> JQKA = new HashMap<>();
    ...
    public static void sort() throws FileNotFoundException {
        Scanner input = new Scanner(new File("F:\\Program\\java\\IDEA\\Arithmetic\\src\\www\\homework\\chapter_3\\TopList.txt"));
        //input.useDelimiter("\r\n");
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            if (select == 3) {
                ...
                File user = new File("F:\\Program\\java\\IDEA\\Arithmetic\\src\\www\\homework\\chapter_3\\TopList.txt");
