package www.homework.embarkationfournext;
...
public class ComputerProduct {
    ...
    public static void main(String[] args) {
        ...
        IFactory MacFactory = Factory.getInstance("www.homework.embarkationfournext.MacFactory");
        computerProduct.buyCpu(MacFactory.createCpu());
        computerProduct.buyRam(MacFactory.createRam());
        IFactory PcFactory = Factory.getInstance("www.homework.embarkationfournext.PcFactory");
