package www.homework.chapterfour.test;
...
public class ReflectFruitFactory {
    public static void main(String[] args) {
        Food fruit = FruitFactory.getInstance("www.homework.chapterfour.test.Apple") ;
        fruit.eat() ;
        Food orange = FruitFactory.getInstance("www.homework.chapterfour.test.Orange");
        orange.eat();
    }
}